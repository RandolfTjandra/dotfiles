...
# Terminal editor for tabular data
brew "ehfeng/ted/ted"
# A CLI wrapper for libkeyfinder. Making DJs lives easier.
brew "evanpurkhiser/personal/keyfinder-cli"
# Custom macOS statusbar with shell plugin, interaction and graph support
brew "felixkratz/formulae/sketchybar"
# Is a small cli program written in rust to easily convert images to ascii art
brew "finefindus/tap/artem"
# prettier, on SPEED!
...
cask "codex"
# Dark theme for Steam
cask "dracula/install/dracula-steam"
